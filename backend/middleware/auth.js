...
if (!JWT_SECRET || JWT_SECRET.includes('your-') || JWT_SECRET.includes('change-this') || JWT_SECRET.length < 32) {
  console.error('FATAL: JWT_SECRET must be set to a strong value (min 32 chars) in environment variables');
