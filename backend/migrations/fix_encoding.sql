-- Fix character encoding for homepage_sections
SET NAMES utf8mb4;
...
WHERE section_key = 'implementation';

-- Update zoonoses section
UPDATE homepage_sections SET
  content_fr = JSON_OBJECT(
