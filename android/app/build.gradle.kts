...
val releaseKeystoreFile: String? = localProperties.getProperty("KEYSTORE_FILE")
...
android {
    namespace = "cm.onehealth.cohrm"
    compileSdk = 34

    defaultConfig {
        applicationId = "cm.onehealth.cohrm"
        minSdk = 24
        targetSdk = 34
        versionCode = 2
        versionName = "1.1.0-fix401"

        testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"

        manifestPlaceholders["MAPS_API_KEY"] = mapsApiKey

        buildConfigField("String", "API_BASE_URL", "\"https://onehealth.cm/api/cohrm/\"")
        buildConfigField("String", "SMS_RECIPIENT", "\"+237600000000\"")
    }
